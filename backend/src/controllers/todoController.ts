...
export const getTodos = async (req: express.Request, res: express.Response): Promise<void> => {
...
export const createTodo = async (req: express.Request, res: express.Response): Promise<void> => {
    const { task } = req.body;
    const userId = res.locals.userId;
    try {
